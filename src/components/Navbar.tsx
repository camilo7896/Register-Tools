      ...
      <nav className="border-gray-200 dark:bg-gray-900 p-5 navbar-bg">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse relative">
            ...
            <div
              ref={menuRef}
              className={`absolute right-0 mt-70 w-56 z-50 ${
                menuOpen ? "" : "hidden"
              } text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600`}
              id="user-dropdown"
            >
              <div className="px-4 py-3 bg-gray-100">
                <strong className="block text-sm dark:text-blue-970 || text-black">
                  Usuario
                </strong>
                <span className="block text-sm  text-gray-500 truncate dark:text-gray-600">
                  {Userloged}
                </span>
              </div>
              ...
              <button
                ...
                className="bg-gray-600 text-white text-center block w-full font-semibold px-4 py-2 text-sm hover:bg-gray-500 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"
              >
                Cerrar sesión
              </button>
            </div>
          ...
          >
            <ul className=" menu flex flex-col font-medium p-4 md:p-0 mt-24 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link
                  to="/formtool"
                  className="items block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Formulario
                </Link>
              </li>
              ...
              {(userRole === "superadmin" || userRole === "admin") && (
                <li>
                  <Link
                    to="/admin"
                    className=" menu flex flex-col font-medium p-4 md:p-0 mt-24 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
                  >
                    Administrador
                  </Link>
                </li>
